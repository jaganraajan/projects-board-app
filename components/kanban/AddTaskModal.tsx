...
import { TaskPriority } from '@/lib/api/client';
    ...
    >
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Add to {columnName}</Text>
            ...
            <View style={styles.previewCard}>
              ...
              <View style={styles.previewFooter}>
                <View style={styles.previewPriority}>
                  <Text style={styles.previewPriorityText}>{priority}</Text>
                </View>
                <Text style={styles.previewDate}>
                  {formatDateForDisplay(dueDate).split(',')[0]}
                </Text>
              </View>
            </View>
          </View>
